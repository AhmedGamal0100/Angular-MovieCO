...
import { wishGuard } from './guards/wish.guard';
...
export const routes: Routes = [
    { path: '', redirectTo: 'home', pathMatch: 'full' },
    {
        ...
        children: [
            ...
            { path: 'wishlist', canActivate: [wishGuard], loadComponent: () => import('./pages/wish-list/wish-list.component').then(m => m.WishListComponent), pathMatch: 'full' },
